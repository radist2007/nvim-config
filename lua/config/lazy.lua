...
require("lazy").setup({ -- Головна функція налаштування lazy.nvim
  ...
  defaults = {
    -- lazy = false: Твої плагіни за замовчуванням НЕ ліниві (завантажуються при старті).
    -- Якщо поставити true, вони будуть завантажуватись тільки при потребі (швидший старт).
    lazy = false,
